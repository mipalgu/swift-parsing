...
/// The three-engine differential contract for the structural Lua grammar.
///
...
/// granularities. This is the headline acceptance gate: it proves the framework parses a real language
/// identically on all three native engines.
@Suite("Lua three-engine differential")
struct LuaDifferentialTests {
