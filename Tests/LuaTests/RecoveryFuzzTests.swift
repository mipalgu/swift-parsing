...
/// Property-based recovery differential for the structural Lua grammar.
///
...
@Suite("Lua recovery fuzz differential")
struct LuaRecoveryFuzzTests {
...
/// Deterministic recovery-differential fuzzing, shared in spirit with the C and JSON structural suites.
///
